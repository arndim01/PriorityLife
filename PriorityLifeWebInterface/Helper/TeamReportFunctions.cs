...
{
    public class TeamReportFunctions
    {
        private TeamReportFunctions()
        {

        }

        internal static List<TeamCustomReportModel> SortReport(List<TeamCustomReportModel> reports, string sidx, string sord, int startIndex, int row)
        {
            if (sord == "desc")
            {
                switch (sidx)
        ...
        internal static List<TeamCustomReportModel> GetReport(List<PriorityLifeAPI.Models.TeamReport> reports)
        {

            reports = reports.OrderBy(c => c.TeamName).ToList();
            List<TeamCustomReportModel> customModel = new List<TeamCustomReportModel>();
            foreach (var list in reports)
            {
                ...
                else
                {
                    ...
                    customModel.Add(new TeamCustomReportModel
                    {
                        Id = list.Rank,
