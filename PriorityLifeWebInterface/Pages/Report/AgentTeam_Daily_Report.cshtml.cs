...
{
    public class AgentTeam_Daily_ReportModel : PageModel
    {
        public IActionResult OnPostCreateDocument()
        {
            ...
            try
            {
                List<PriorityLifeAPI.Models.AgentTeamReport> objCommissionsCol = Commissions.GetTeamManagerReportByDate(DateTime.Now);
                byte[] fileContents = ReportFunctions.GenerateStreamExcelReportTeamManager(objCommissionsCol, "DAILY");
                ...
                return File(
                    ...
                    fileDownloadName: "Daily_AgentTeamReport.xlsx"
                );
            }
            catch
            {
        ...
        {
            List<PriorityLifeAPI.Models.AgentTeamReport> reports = Commissions.GetTeamManagerReportByDate(DateTime.Now.AddDays(-1));
