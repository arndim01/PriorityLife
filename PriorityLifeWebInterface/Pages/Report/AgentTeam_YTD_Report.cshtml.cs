...
{
    public class AgentTeam_YTD_ReportModel : PageModel
    {
        public IActionResult OnPostCreateDocument()
        {
            ...
            try
            {
                List<PriorityLifeAPI.Models.AgentTeamReport> objCommissionsCol = Commissions.GetTeamManagerReportByDateRange(new DateTime(DateTime.Now.Year, 1, 1), DateTime.Now.AddDays(-1));
                byte[] fileContents = ReportFunctions.GenerateStreamExcelReportTeamManager(objCommissionsCol, "YTD");
                ...
                return File(
                    ...
                    fileDownloadName: "YTD_AgentTeamReport.xlsx"
                );
            }
            catch
            {
        ...
        {
            List<PriorityLifeAPI.Models.AgentTeamReport> reports = Commissions.GetTeamManagerReportByDateRange(new DateTime(DateTime.Now.Year, 1, 1), DateTime.Now.AddDays(-1));
            var cus_reports = TeamAgentReportFunctions.GetReport(reports);
            int totalRecords = cus_reports.Count;
