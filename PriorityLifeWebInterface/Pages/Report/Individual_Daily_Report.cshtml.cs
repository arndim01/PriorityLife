...
{
    [Authorize]
    public class Individual_Daily_ReportModel : PageModel
    {
        public IActionResult OnPostCreateDocument()
        {
            ...
            try
            {
                ...
                byte[] fileContents = ReportFunctions.GenerateStreamExcelReport(objCommissionsCol, "DAILY");
                ...
                return File(
                    ...
                    fileDownloadName: "Daily_IndividualReport.xlsx"
                );
            }
            catch
            {
        ...
        {
            List<Commissions> objCommissionsCol = Commissions.GetReportByDate(DateTime.Now.AddDays(-1));
