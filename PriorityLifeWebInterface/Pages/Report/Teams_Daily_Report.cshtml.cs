...
{
    public class Teams_Daily_ReportModel : PageModel
    {
        public IActionResult OnPostCreateDocument()
        {
            ...
            try
            {
                List<PriorityLifeAPI.Models.TeamReport> objCommissionsCol = Commissions.GetTeamsReportByDate(DateTime.Now);
                byte[] fileContents = ReportFunctions.GenerateStreamExcelReportTeam(objCommissionsCol, "DAILY");
                ...
                return File(
                    ...
                    fileDownloadName: "Daily_TeamReport.xlsx"
                );
            }
            catch
            {
        ...
        {   
            List<PriorityLifeAPI.Models.TeamReport> reports = Commissions.GetTeamsReportByDate(DateTime.Now.AddDays(-1));
