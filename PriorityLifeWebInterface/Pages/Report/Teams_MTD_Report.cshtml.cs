...
{
    public class Teams_MTD_ReportModel : PageModel
    {
        public IActionResult OnPostCreateDocument()
        {
            ...
            try
            {
                List<PriorityLifeAPI.Models.TeamReport> objCommissionsCol = Commissions.GetTeamsReportByDateRange(ReportFunctions.FirstDayOfMonth(DateTime.Now), DateTime.Now.AddDays(-1));
                byte[] fileContents = ReportFunctions.GenerateStreamExcelReportTeam(objCommissionsCol, "MTD");
                ...
                return File(
                    ...
                    fileDownloadName: "MTD_TeamReport.xlsx"
                );
            }
            catch
            {
        ...
        {
            List<PriorityLifeAPI.Models.TeamReport> reports = Commissions.GetTeamsReportByDateRange(ReportFunctions.FirstDayOfMonth(DateTime.Now), DateTime.Now.AddDays(-1));
