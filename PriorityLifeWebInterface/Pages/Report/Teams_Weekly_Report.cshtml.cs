...
{
    public class Teams_Weekly_ReportModel : PageModel
    {
        public IActionResult OnPostCreateDocument()
        {
            ...
            try
            {
                List<PriorityLifeAPI.Models.TeamReport> objCommissionsCol = Commissions.GetTeamsReportByDateRange(ReportFunctions.FirstDayOfWeek(DateTime.Now), ReportFunctions.LastDayOfWeek(DateTime.Now.AddDays(-1)));
                byte[] fileContents = ReportFunctions.GenerateStreamExcelReportTeam(objCommissionsCol, "WEEKLY");
                ...
                return File(
                    ...
                    fileDownloadName: "Weekly_TeamReport.xlsx"
                );
            }
            catch
            {
        ...
        {
            List<PriorityLifeAPI.Models.TeamReport> reports = Commissions.GetTeamsReportByDateRange(ReportFunctions.FirstDayOfWeek(DateTime.Now), ReportFunctions.LastDayOfWeek(DateTime.Now.AddDays(-1)));
