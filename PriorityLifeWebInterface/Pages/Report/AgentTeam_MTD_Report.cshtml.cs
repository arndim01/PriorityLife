...
{
    public class AgentTeam_MTD_ReportModel : PageModel
    {
        public IActionResult OnPostCreateDocument()
        {
            ...
            try
            {
                List<PriorityLifeAPI.Models.AgentTeamReport> objCommissionsCol = Commissions.GetTeamManagerReportByDateRange(ReportFunctions.FirstDayOfMonth(DateTime.Now), DateTime.Now.AddDays(-1));
                byte[] fileContents = ReportFunctions.GenerateStreamExcelReportTeamManager(objCommissionsCol, "MTD");
                ...
                return File(
                    ...
                    fileDownloadName: "MTD_AgentTeamReport.xlsx"
                );
            }
            catch
            {
        ...
        {
            List<PriorityLifeAPI.Models.AgentTeamReport> reports = Commissions.GetTeamManagerReportByDateRange(ReportFunctions.FirstDayOfMonth(DateTime.Now), DateTime.Now.AddDays(-1));
